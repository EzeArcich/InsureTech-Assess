...
<section class="py-2">
    ...
    <div class="d-flex flex-wrap align-items-center justify-content-between gap-2 mb-3">
        <div>
            <h3 class="mb-0 fw-bold">Ingresar taller</h3>
        ...
        <div class="panel mb-3">
            ...
            <div class="row g-3">
                ...
                <div class="col-12 col-md-4">
                    ...
                    <input type="text" name="taller" id="taller" class="form-control" value="{{ old('taller') }}">
                </div>

                <div class="col-12 col-md-4">
                    <label for="razon" class="form-label">Razón social</label>
                    <input type="text" name="razon" id="razon" class="form-control" value="{{ old('razon') }}">
                </div>
                ...
                <div class="col-12 col-md-6">
                    ...
                    <input type="text" name="zona" id="zona" class="form-control" value="{{ old('zona') }}">
                </div>
        ...
        <div class="panel mb-3">
            ...
            <div class="row g-3">
                ...
                <div class="col-12 col-md-4">
                    ...
                    <input type="text" name="grua" id="grua" class="form-control" value="{{ old('grua') }}">
                </div>

                <div class="col-12 col-md-4">
                    <label for="traslado" class="form-label">Traslado</label>
                    <input type="text" name="traslado" id="traslado" class="form-control" value="{{ old('traslado') }}">
                </div>

                <div class="col-12 col-md-4">
                    <label for="granizo" class="form-label">Granizo</label>
                    <input type="text" name="granizo" id="granizo" class="form-control" value="{{ old('granizo') }}">
                </div>

                <div class="col-12 col-md-4">
                    <label for="ponerep" class="form-label">Pone repuestos</label>
                    <input type="text" name="ponerep" id="ponerep" class="form-control" value="{{ old('ponerep') }}">
                </div>

                <div class="col-12 col-md-4">
                    <label for="vacaciones" class="form-label">Vacaciones</label>
                    <input type="text" name="vacaciones" id="vacaciones" class="form-control" value="{{ old('vacaciones') }}">
                </div>

                <div class="col-12 col-md-4">
                    <label for="descfranq" class="form-label">Descuento de franquicia</label>
                    <input type="text" name="descfranq" id="descfranq" class="form-control" value="{{ old('descfranq') }}">
                </div>
